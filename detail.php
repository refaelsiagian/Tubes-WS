...
$query = '
    ...
    SELECT DISTINCT ?name ?province ?description ?thumbnail ?category ?location ?built ?discovered 
    WHERE {
...
$mapQuery = '
    SELECT DISTINCT * WHERE {
        dbr:' . str_replace(' ', '_', $destination) . ' geo:lat  ?lat;
                                                       geo:long ?long .
    }
';
                            ...
                            <div class="mt-4">
                                <?php if ($result2): ?>
                                    <iframe width="100%" height="376.875px" style="border:0;" allowfullscreen="" 
                                            ...
                                            src="https://maps.google.com/maps?q=<?= $result2->lat ?>,<?= $result2->long ?>&hl=en&z=14&amp;output=embed">
                                    </iframe>
